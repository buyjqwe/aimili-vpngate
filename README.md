...
#### 🌟 正式稳定版本 (main 分支)
```bash
bash <(curl -Ls https://raw.githubusercontent.com/buyjqwe/aimili-vpngate/main/install.sh)
```

#### 🧪 测试开发版本 (bate 分支)
```bash
bash <(curl -Ls https://raw.githubusercontent.com/buyjqwe/aimili-vpngate/bate/install.sh)
```
